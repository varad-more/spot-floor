...
from spotfloor.alerts.evaluator import step
from spotfloor.alerts.rules import MISSING, AlertRule, EventKind, Metric, RuleState
...
def main() -> None:
    ...
    print("events emitted by spotfloor:")
    ...
    print(f"\n  spotfloor (hysteresis): {sum(1 for _, k, _ in fired if k is EventKind.TRIGGERED)} alerts")
